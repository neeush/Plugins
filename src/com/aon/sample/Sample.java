 ...
 * <p>
 */
public class Sample extends Plugin {
	...
	public PluginService[] getServices() {
		return new PluginService[] { new WorkItemReassignService()};
	}
	...
	public String getConfigurationDijitClass() {
		return "sampleDojo.ConfigurationPane";
	}
	...
	/**
		...
		/*public com.ibm.ecm.extension.PluginRequestFilter[] getRequestFilters() {
			return new com.ibm.ecm.extension.PluginRequestFilter[]{new com.aon.Request.SampleRequest()};
		}*/
	...
	/*public com.ibm.ecm.extension.PluginResponseFilter[] getResponseFilters() {
		return new com.ibm.ecm.extension.PluginResponseFilter[]{new com.aon.Response.SampleResponse()};
	}*/
	...
	public com.ibm.ecm.extension.PluginAction[] getActions() {
		return new com.ibm.ecm.extension.PluginAction[]{new com.aon.sample.action()};
	}
